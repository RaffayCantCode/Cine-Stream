...
export const HeroAnnouncement = memo(function HeroAnnouncement() {
  ...
  return (
    <div
      className="absolute top-[4.25rem] sm:top-[4.5rem] md:top-6 left-3 sm:left-6 md:left-8 lg:left-10 z-30 max-w-[calc(100%-1.5rem)] sm:max-w-md md:max-w-lg lg:max-w-xl pointer-events-auto transition-all duration-300 animate-fade-in-up"
      role="region"
