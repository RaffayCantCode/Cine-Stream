      ...
      <main className="flex-1 md:pl-56 lg:pl-64 h-[100dvh] overflow-y-auto w-full custom-scrollbar relative bg-[#070913]">
        ...
        <div className="relative pt-24 md:pt-20 pb-12 px-5 md:px-10 lg:px-16 flex flex-col md:flex-row items-center md:items-end justify-between min-h-[240px]">
          <div className="absolute inset-0 z-0 pointer-events-none">
             <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-900/25 via-purple-950/10 to-transparent" />
          ...
          <div className="relative z-10 text-center md:text-left mb-4 md:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-2">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-amber-300 via-white to-indigo-300 drop-shadow-md">
                Epic
              </span>
              <span className="text-white ml-3">Franchises</span>
            </h1>
            <p className="text-white/60 font-medium max-w-lg mt-2 md:mt-3 text-sm md:text-base leading-relaxed">
        ...
        <div className="px-5 md:px-10 lg:px-16 relative z-10">
          ...
          <div className="mt-4 md:mt-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 md:gap-6 pb-24">
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                    <h4 className="text-white font-extrabold text-sm md:text-base tracking-tight line-clamp-2 drop-shadow-md mb-1.5 group-hover:text-indigo-300 transition-colors">
                      {col.name}
                    </h4>
