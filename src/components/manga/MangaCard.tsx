  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 inset-x-3 flex items-center justify-between pointer-events-none z-10">
        <span className="px-2.5 py-1 rounded-lg bg-black/95 text-[#42f5dd] border border-white/20 shadow-[0_4px_16px_rgba(0,0,0,0.95)] text-[10px] font-black uppercase tracking-wider backdrop-blur-md">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 z-20 pointer-events-none">
        <div className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#42f5dd] text-black text-xs font-black shadow-2xl shadow-[#42f5dd]/40 scale-75 group-hover:scale-100 transition-transform duration-300 border border-[#42f5dd]/60 backdrop-blur-sm">
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-4.5 flex flex-col justify-end gap-1.5 z-10">
        <h3
          className="font-black text-base sm:text-lg text-white tracking-tight line-clamp-2 leading-tight drop-shadow-md group-hover:text-[#42f5dd] transition-colors"
          title={item.title}
        >
          {item.title}
        </h3>
        ...
        <div className="flex items-center justify-between text-xs text-white/70 font-bold">
          <span className="truncate max-w-[130px] drop-shadow-sm text-[#42f5dd]/90 font-black">
